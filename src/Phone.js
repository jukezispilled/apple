...
const Phone = () => {
  ...
  return (
    <div className="relative flex flex-col items-center justify-center min-h-screen bg-gradient-to-b from-blue-300 to-blue-600">
      <div className='absolute bottom-3 text-gray-400 text-[10px]'>CA: soon...</div>  

      <div className='absolute top-3 left-3 flex items-center z-[50]'>
        <a href="https://x.com/aDOGtoken" className='transition ease-in-out duration-150'>
        ...
        <a href="https://t.me/aDOGport" className='transition ease-in-out duration-150'>
          <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" className='w-10 h-10 md:w-12 md:h-12 md:hover:scale-105 transition ease-in-out duration-150 cursor-pointer' fill="#9ca3af" viewBox="0 0 50 50">
